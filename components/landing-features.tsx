    ...
    <div className='px-10 pb-20'>
      ...
      {/* <div className='fixed inset-x-6 bottom-6 z-40 mx-auto w-max'>
        <a
          ...
          target='_blank'
          className='flex gap-3 rounded-2xl border border-white/10 bg-gradient-to-br from-black/70 to-gray-800 dark:border-yellow-900/30 dark:from-gray-800 dark:to-black/70 p-3 shadow-2xl shadow-primary/50 backdrop-blur-xl'
        >
          <svg
